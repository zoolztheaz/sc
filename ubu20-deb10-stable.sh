...
clear
# REPO    
REPO="https://raw.githubusercontent.com/zoolztheaz/sc/master/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="http://zool.gaskan.eu.org/ip"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="1207375389"
KEY="6812561422:AAG_f0i2YVsbQCCs2ngY0P7GgTFaScFSu5w"
...
wget -q https://raw.githubusercontent.com/zoolztheaz/sc/master/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
